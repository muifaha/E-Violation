    ...
    <div class="container my-2">
        <div class="row mb-4">
            ...
            <div class="head row col-10">
                ...
                <h6 class="mb-1">Jl. Smea No.4, Wonokromo, Kec. Wonokromo, Kota SBY, Jawa Timur 60243, Telp. 031-8292038</h6>
                <h6 class="mb-1">
        ...
        <hr class="mb-1"><hr class="mt-1">
        <div class="content">
            <div class="row mx-0" style="justify-content: space-between; margin-top: 30px">
                <p>Perihal : <b class="ms-2">Undangan</b></p>
                <p><b>Surabaya, 31 Januari 2023</b></p>
            </div>
            <div class="yth mt-4">
                <p>Yth. Bapak/Ibu Orang Tua/Wali Murid</b></p>
                <p>Iksan Arya Dinata</p>
                <p>Kelas 12 RPL 2</p>
                <p>di Tempat</p>
            </div>
            <div class="hormat mt-5">
                <p class="mb-1">Dengan hormat,</p>
                <p>Sehubungan dengan adanya sesuatu yang perlu disampaikan kepada Bapak/Ibu, maka Kami mengundang Bapak/Ibu untuk hadir pada :</p>
            </div>
            <div class="isi mx-5 pt-4">
                <div class="row">
                    <p>Hari</p>
                    <p> : <b class="ms-1">Selasa</b></p>
                </div>
                <div class="row">
                    <p>Tanggal</p>
                    <p> : <b class="ms-1">31 Januari 2023</b></p>
                </div>
                <div class="row">
                    <p>Jam</p>
                    <p> : <b class="ms-1">08.00 WIB - Selesai</b></p>
                </div>
                <div class="row">
                    <p>Tempat</p>
            ...
            <div class="hormat mt-4">
                <p>Mengingat sangat pentingnya hal di atas dimohon Bapak/Ibu untuk bersedia hadir tepat waktu. Atas perhatian dan kehadirannya Kami ucapkan terima kasih.</p>
            </div>
