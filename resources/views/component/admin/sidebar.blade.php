    ...
    <div class="l-sidebar__content">
        <nav class="c-menu js-menu">
            <ul class="u-list">
              ...
              <li class="c-menu__item {{ request()->is('daftar-siswa*') ? 'is-active' : '' }} has-submenu" data-toggle="tooltip" title="Skor Siswa">
              ...
              <li class="c-menu__item {{ request()->is('guru*') ? 'is-active' : '' }} has-submenu" data-toggle="tooltip" title="Histori Skor">
              ...
              <li class="c-menu__item {{ request()->is('tata-tertib*') ? 'is-active' : '' }} has-submenu" data-toggle="tooltip" title="Tata Tertib">
