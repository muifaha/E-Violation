    ...
    */
    ...
    'custom' => [
        'nama' => [
            ...
            'max' => 'Tempat lahir tidak lebih dari :max karakter',
        ],
        'nisn' => [
        ...
        'jk' => [
            ...
            'max' => 'Jenis kelamin tidak lebih dari :max karakter',
        ],
        'agama' => [
            'required' => 'Agama harus diisi!',
            'max' => 'Agama tidak lebih dari :max karakter',
        ],
        'alamat' => [
            'required' => 'Tempat lahir harus diisi!',
            'max' => 'Tempat lahir tidak lebih dari :max karakter',
        ...
        'jurusan' => [
            ...
            'max' => 'Jurusan tidak lebih dari :max karakter',
        ],
        'n_ayah' => [
            'required' => 'Nama ayah harus diisi!',
            'max' => 'Nama ayah tidak lebih dari :max karakter',
        ],
        'n_ibu' => [
            'required' => 'Nama ibu harus diisi!',
            'max' => 'Nama ibu tidak lebih dari :max karakter',
        ],
        'alamat_ortu' => [
            'required' => 'Alamat orang tua harus diisi!',
            'max' => 'Alamat orang tua tidak lebih dari :max karakter',
        ],
        'no_telp_rumah' => [
